...
HAPI b8 resource_system_register_loader(resource_loader loader);

HAPI b8 resource_system_load(const char* name, resource_type type, resource* out_resource);
HAPI b8 resource_system_load_custom(const char* name, const char* custom_type, resource* out_resource);

HAPI void resource_system_unload(resource* resource);

HAPI const char* resource_system_base_path();
