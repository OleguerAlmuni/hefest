 ...
 */
HAPI void hashtable_destroy(hashtable* table);
 ...
 */
HAPI b8 hashtable_set(hashtable* table, const char* name, void* value);
 ...
 */
HAPI b8 hashtable_set_ptr(hashtable* table, const char* name, void** value);
 ...
 * @return True; or false if a null pointer is passed.
 */
HAPI b8 hashtable_get(hashtable* table, const char* name, void* out_value);
 ...
 */
HAPI b8 hashtable_get_ptr(hashtable* table, const char* name, void** out_value);
 ...
 */
HAPI b8 hashtable_fill(hashtable* table, void* value);